...
},
{
  ...
  image: "image/Hyperion.jpg"
    ...
    genres.forEach(function(genre) {
      ...
      const genreRowContainer = $('<div class="row genre-row-container"></div>');
      const genreRow = $('<div class="genre-row"></div>');
      genreBooks.forEach(function(book) {
        const cardHtml = generateCard(book);
        genreRow.append(cardHtml);
      });
      genreRowContainer.append($('<div class="col-12"><h2>' + genre + '</h2></div>'));
      genreRowContainer.append(genreRow);
      $('.container').append(genreRowContainer);
    });
  });